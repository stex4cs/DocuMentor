 ...
 */
export function extractComments(content: string): Record<string, string> {
 ...
 */
export function extractExpressRoutes(content: string): Array<{
  method: string;
  path: string;
  handlerName: string;
}> {
 ...
 */
export function extractNestDecorators(content: string): {
  controller?: {
    path: string;
    name: string;
  };
